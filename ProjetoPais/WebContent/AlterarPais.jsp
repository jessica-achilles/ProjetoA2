                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="populacao" id="populacao" maxlength="10" placeholder="população do país" value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="area">Área</label>
                                <input type="text" class="form-control" name="area" id="area" required maxlength="10" placeholder="área do país" value="${pais.area }">
                            </div>
                        </div>
                        <hr />
